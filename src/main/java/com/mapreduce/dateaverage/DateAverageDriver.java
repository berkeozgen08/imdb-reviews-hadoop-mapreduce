...
public class DateAverageDriver {
	public static void main(String[] args) {
        ...
        job_conf.setMapperClass(DateAverageMapper.class);
        job_conf.setReducerClass(DateAverageReducer.class);
