...
public class TotalReviewsDriver {
	public static void main(String[] args) {
        ...
        job_conf.setMapperClass(TotalReviewsMapper.class);
        job_conf.setReducerClass(TotalReviewsReducer.class);
